...
class Vox_util(object):
    ...
    def voxelize_xyz(self, xyz_ref, Z, Y, X, already_mem=False):
    ...
    def apply_pixX_T_memR_to_voxR(self, pix_T_camX, camX_T_camR, voxR, D, H, W, logspace_slices=False):
        # mats are B x 4 x 4
    ...
    def assemble_padded_obj_masklist(self, lrtlist, scorelist, Z, Y, X, coeff=1.0):
