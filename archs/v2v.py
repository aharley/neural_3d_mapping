...
class EncoderDecoder(nn.Module):
    def __init__(self, in_dim=32, scale=0.125):
        ...
        self.encoder_res1 = Res3DBlock(in_dim, 64)
        ...
        self.skip_res1 = Res3DBlock(in_dim, 32)
...
class V2VModel(nn.Module):
    def __init__(self, input_channels, output_channels):
        ...
        # self.output_layer = nn.Conv3d(32, output_channels, kernel_size=1, stride=1, padding=0) # full res
        self.output_layer = nn.Conv3d(64, output_channels, kernel_size=1, stride=1, padding=0) # 1/2 res
        # self.output_layer = nn.Conv3d(128, output_channels, kernel_size=1, stride=1, padding=0) # 1/4 res
        # self.output_layer = nn.Conv3d(128, output_channels, kernel_size=1, stride=1, padding=0) # 1/8 res
