...
class Summ_writer(object):
    ...
    def summ_oneds(self, name, ims, bev=False, logvis=False, maxval=50.0, norm=True, only_return=False):
        if self.save_this:
    ...
    def summ_oned(self, name, im, bev=False, logvis=False, maxval=0, norm=True, only_return=False):
        if self.save_this:
